...
let OfferCard = props => (
  <>
    <div className="offer main-card" key={props.offer.id}>
      ...
      <Link
        onClick={() => {
          props.thisCtx.toggle(props.offer.id);
        }}
      >
        View offer
      </Link>
    ...
    <OfferModal
      {...props.thisCtx.state}
      {...props.thisCtx.props}
      close={props.thisCtx.toggle}
      // toggle es distinto, creo que el de filteredOffer es el antiguo metodo
      toggle={props.thisCtx.props.location.pathname === `/${props.offer.id}`}
      ...
      authorProfileImage={props.offer.authorProfileImage}
...
class OfferList extends Component {
  ...
  render() {
    ...
    const renderOffers = firstOffers.map(offer => <OfferCard offer={offer} thisCtx={this}/>);

    //Offers you get when you search
    let renderFilteredOffers = this.props.filteredOffers.map(filteredOffer => <OfferCard offer={filteredOffer} thisCtx={this}/>);
...
//             <h3>{offer.title}</h3>
//             <h4>
//               <strong>User</strong>: {offer.authorUsername}
//             </h4>
...
//             {/* TODO */}
//             <img
//               src={`${process.env.REACT_APP_API}/${filteredOffer.authorProfileImage}`}
//               alt=""
//             />
//             <h4>
//               <strong>User</strong>: {filteredOffer.authorUsername}
//             </h4>
//             <p>{filteredOffer.description}</p>
//             <p>
//               <strong>Category</strong>: {filteredOffer.category}
//             </p>
//             <Link
//               onClick={() => {
//                 this.toggle(filteredOffer.id);
//               }}
//             >
//               View offer
//             </Link>
