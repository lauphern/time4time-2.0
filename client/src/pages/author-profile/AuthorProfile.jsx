  ...
  handleSubmitReview = event => {
    ...
    customAxios({
      ...
      .then(databaseResponse => {
        this.setState({
          success: "You successfully added a review!",
          newReview: databaseResponse.data
        });
      })
      .then(() => {
        // this.sendUserId();
        ...
        <div>
          ...
          <div>
            <div>
              <div>
                <p>
                  {this.state.authorProfile.firstname}&nbsp;
                  {this.state.authorProfile.lastname}
                </p>
                <div>
                  <p>
                    In the app from: &nbsp;
                    <Moment format="D MMM YYYY" withTitle>
                      {this.state.authorProfile.registrationDate}
                    </Moment>
                  </p>
                </div>
              </div>
        ...
        <div>
          ...
          {this.state.listOfReviews.length > 0 ? (
            <>
              ...
              <div
                id="scrollableDiv"
                style={{ height: "70vh", overflow: "auto", "z-index": 100 }}
              >
                <InfiniteScroll
